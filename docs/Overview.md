...
Welcome to the Hydrogen documentation. If you are new to Hydrogen, start with
the [features](Features.md) and [installation](Installation.md)
documents.

## Overview information

- [Features](Features.md): A high-level list of features in Hydrogen.
- [FAQ](FAQ.md): Frequently asked questions.
- ~~[Releases (Klipper)](Releases_Klipper.md): The history of Klipper releases.~~
...
communication with the Hydrogen developers.

## Installation and Configuration

- [Installation](Installation.md): Guide to installing Hydrogen.
  - [Octoprint](OctoPrint.md): Guide to installing Octoprint with Hydrogen.
...
- [Config checks](Config_checks.md): Verify basic pin settings in the
  config file.
- [Bed level](Bed_Level.md): Information on "bed leveling" in Hydrogen.
...
- [Pressure advance](Pressure_Advance.md): Calibrate extruder
  pressure.
- [G-Codes](G-Codes.md): Information on commands supported by Hydrogen.
...
- [Slicers](Slicers.md): Configure "slicer" software for Hydrogen.
...
- [Code overview](Code_Overview.md): Developers should read this
  first.
- [Kinematics](Kinematics.md): Technical details on how Hydrogen
  implements motion.
- [Protocol](Protocol.md): Information on the low-level messaging
  protocol between host and micro-controller.
- [API Server](API_Server.md): Information on Hydrogen's command and
  control API.
- [MCU commands](MCU_Commands.md): A description of low-level commands
  implemented in the micro-controller software.
- [CAN bus protocol](CANBUS_protocol.md): Hydrogen CAN bus message
  format.
- [Debugging](Debugging.md): Information on how to test and debug
  Hydrogen.
- [Benchmarks](Benchmarks.md): Information on the Hydrogen benchmark
  method.
- ~~[Contributing (Klipper)](CONTRIBUTING_Klipper.md): Information on how to submit
...
- [Example configs](Example_Configs.md): Information on adding an
  example config file to Hydrogen.
...
- [Beaglebone](Beaglebone.md): Details for running Hydrogen on the
  Beaglebone PRU.
- [Bootloaders](Bootloaders.md): Developer information on
  micro-controller flashing.
- [Bootloader Entry](Bootloader_Entry.md): Requesting the bootloader.
- [CAN bus](CANBUS.md): Information on using CAN bus with Hydrogen.
